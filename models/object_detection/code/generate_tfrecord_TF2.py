...
# https://jennaweng0621.pixnet.net/blog/post/404323208
# change from TF 2.x
flags = tf.compat.v1.flags  # if TF 1.x using "tf.app.flags"
...
def main(_):
#https://blog.csdn.net/Mint_vip/article/details/100775875
